...
function start() {
  ...
  // Validate that the interval evenly divides 60 so the cron
  ...
  if (!Number.isInteger(intervalSeconds) || intervalSeconds < 1 || intervalSeconds > 59 || 60 % intervalSeconds !== 0) {
    throw new Error(
      `airdrops.expiryCheckIntervalSeconds must be a whole number between 1 and 59 that evenly divides 60 ` +
